...
- Assessment run ID | معرّف تشغيل التقييم: `run-9390b4c4cfc145b4`
- Generated UTC | وقت الإنشاء: 2026-09-22T06:22:09.851252+00:00
...
- Median latency | وسيط الزمن: 3.035 ms
- Trace records | سجلات التتبع: 286
...
- New threat case metadata | بيانات الحالة الجديدة: `{"asset": "Refund policy evidence", "case_id": "L-SEC-01", "control": "Allow only active and current policy versions before retrieval and decision-making.", "expected_flag": "policy_downgrade", "payload_length": 83}`
...
- Before | قبل: 21.917 ms / 500 iterations
- After | بعد: 6.752 ms / 500 iterations
- Cache hits / misses | إصابات / إخفاقات التخزين: 499 / 1
- Learner trade-off and guardrail | مقايضة وضابط المتدرب: Measured trade-off: for 500 policy lookups, caching reduced runtime from 21.917 ms to 6.752 ms, but cached policy data can become stale. Guardrail: key the cache by locale, category, and active policy version, and never include customer data in the cache key.
