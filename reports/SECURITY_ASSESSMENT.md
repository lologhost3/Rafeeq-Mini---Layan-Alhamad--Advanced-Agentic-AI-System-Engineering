...
- New synthetic case | الحالة الاصطناعية الجديدة: `{"asset": "Refund policy evidence", "case_id": "L-SEC-01", "control": "Allow only active and current policy versions before retrieval and decision-making.", "expected_flag": "policy_downgrade", "payload_length": 83}`
...
- Assessment run ID | معرّف التقييم: `run-03f9fc281938446c`
